...
// $fname = 'test16';
// $lname = 'test16';
// $fullphone = '+17059900287'; // \D [^0-9]
// $email = 'test156lead@gmail.com';
...
try {
	$sh = curl_init('https://marketing.affboat.com/api/v3/integration?api_token=mVec2YGDK6LU9PiU4r8uBjGCP46nLHIjtVXy5h3rP583yeGvfowvx9A3TEVO');
